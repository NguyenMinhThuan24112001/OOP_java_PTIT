 ...
 */
package Dich DichVu_NhanViePhongHoc_Lopcontrollermport co
 controllerPhongHoc_LopcontrollerException;
impor
t controller.IOFile;
...
import javax.swing.JOPhongHoc_Lop.modelPane;
import PhongHoc_Lop.model.swing.table.DefaultTableModel;
import model.DichVu;
...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Nhap hong tin DV");
...
//            if(ten.isEmpty()) throw new TrongException();
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        ...
        if(row>=0&&row<jTable2.getRowCount()){
            ...
            //nếu chọn rồi
            jTextField5.setText(tmNV.getValueAt(row, 0).toString());// lấy ở dòng thứ row và cột thứ đầu tiên
